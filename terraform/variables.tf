...
variable "dmarc_import_es_read_write_role_arn" {
  description = "The ARN of the role that must be assumed in order to read and write to the dmarc-import Elasticsearch database."
  nullable    = false
  type        = string
}
