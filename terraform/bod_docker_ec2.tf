...
module "bod_docker_ansible_provisioner" {
  ...
  envs = [
    ...
    "code_gov_update_file_owner_group=${var.cyhy_user_info.group}",
    "code_gov_update_file_owner_username=${var.cyhy_user_info.name}",
    ...
    "orchestrator_file_owner_group=${var.cyhy_user_info.group}",
    "orchestrator_file_owner_username=${var.cyhy_user_info.name}",
    ...
    "vdp_scanner_file_owner_group=${var.cyhy_user_info.group}",
    "vdp_scanner_file_owner_username=${var.cyhy_user_info.name}",
  ]
