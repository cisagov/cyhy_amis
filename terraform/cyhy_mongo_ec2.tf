...
module "cyhy_mongo_ansible_provisioner" {
  ...
  envs = [
    ...
    "cyhy_archive_file_owner_group=${var.cyhy_user_info.group}",
    "cyhy_archive_file_owner_username=${var.cyhy_user_info.name}",
    "cyhy_archive_s3_bucket_name=${aws_s3_bucket.cyhy_archive.bucket}",
    "cyhy_archive_s3_bucket_region=${var.aws_region}",
    "cyhy_commander_file_owner_group=${var.cyhy_user_info.group}",
    "cyhy_commander_file_owner_username=${var.cyhy_user_info.name}",
    ...
    "cyhy_feeds_file_owner_group=${var.cyhy_user_info.group}",
    "cyhy_feeds_file_owner_username=${var.cyhy_user_info.name}",
