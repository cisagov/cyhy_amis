...
module "cyhy_mongo_ansible_provisioner" {
  ...
  envs = [
    ...
    "cyhy_archive_group=${var.ansible_role_group}",
    "cyhy_archive_user=${var.ansible_role_user}",
    "cyhy_archive_s3_bucket_name=${aws_s3_bucket.cyhy_archive.bucket}",
    "cyhy_archive_s3_bucket_region=${var.aws_region}",
    "cyhy_commander_group=${var.ansible_role_group}",
    "cyhy_commander_user=${var.ansible_role_user}",
    ...
    "cyhy_feeds_group=${var.ansible_role_group}",
    "cyhy_feeds_user=${var.ansible_role_user}",
