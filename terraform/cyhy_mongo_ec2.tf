...
module "cyhy_mongo_ansible_provisioner" {
  ...
  envs = [
    ...
    "cyhy_archive_file_owner_group=${var.ansible_role_group}",
    "cyhy_archive_file_owner_username=${var.ansible_role_user}",
    "cyhy_archive_s3_bucket_name=${aws_s3_bucket.cyhy_archive.bucket}",
    "cyhy_archive_s3_bucket_region=${var.aws_region}",
    "cyhy_commander_file_owner_group=${var.ansible_role_group}",
    "cyhy_commander_file_owner_username=${var.ansible_role_user}",
    ...
    "cyhy_feeds_file_owner_group=${var.ansible_role_group}",
    "cyhy_feeds_file_owner_username=${var.ansible_role_user}",
