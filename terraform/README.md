...
| ebs\_volume\_snapshot\_create\_interval | A positive, non-zero integer denoting the interval in hours at which new snapshots of EBS volumes are to be created (e.g., 5).  Valid values range are non-zero integers that divide 24:  1, 2, 3, 4, 6, 8, 12, 24. | `number` | `12` | no |
