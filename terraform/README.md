...
| dmarc\_import\_es\_read\_write\_role\_arn | The ARN of the role that must be assumed in order to write to the dmarc-import Elasticsearch database. | `string` | n/a | yes |
