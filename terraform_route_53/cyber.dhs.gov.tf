resource "aws_route53_zone" "cyber_dhs_gov_zone" {
  name = "cyber.dhs.gov."
}

resource "aws_route53_record" "root_A" {
  zone_id = "${aws_route53_zone.cyber_dhs_gov_zone.zone_id}"
  name    = "${aws_route53_zone.cyber_dhs_gov_zone.name}"
  type    = "A"
...
resource "aws_route53_record" "_amazonses_TXT" {
  zone_id = "${aws_route53_zone.cyber_dhs_gov_zone.zone_id}"
  name    = "_amazonses.${aws_route53_zone.cyber_dhs_gov_zone.name}"
  type    = "TXT"
  ttl     = 60
...
resource "aws_route53_record" "_dmarc_TXT" {
  zone_id = "${aws_route53_zone.cyber_dhs_gov_zone.zone_id}"
  name    = "_dmarc.${aws_route53_zone.cyber_dhs_gov_zone.name}"
  type    = "TXT"
  ttl     = 3600
...
resource "aws_route53_record" "dmarc_MX" {
  zone_id = "${aws_route53_zone.cyber_dhs_gov_zone.zone_id}"
  name    = "dmarc.${aws_route53_zone.cyber_dhs_gov_zone.name}"
  type    = "MX"
  ttl     = 1800
  records = [ "10 inbound-smtp.us-east-1.amazonaws.com" ]
}
...
resource "aws_route53_record" "_amazonses_dmarc_TXT" {
  zone_id = "${aws_route53_zone.cyber_dhs_gov_zone.zone_id}"
  name    = "_amazonses.dmarc.${aws_route53_zone.cyber_dhs_gov_zone.name}"
  type    = "TXT"
  ttl     = 60
...
resource "aws_route53_record" "wildcard_report_dmarc_TXT" {
  zone_id = "${aws_route53_zone.cyber_dhs_gov_zone.zone_id}"
  name    = "*._report._dmarc.dmarc.${aws_route53_zone.cyber_dhs_gov_zone.name}"
  type    = "TXT"
  ttl     = 300
  records = [ "v=DMARC1" ]
}
...
resource "aws_route53_record" "dkim1_dmarc_CNAME" {
  zone_id = "${aws_route53_zone.cyber_dhs_gov_zone.zone_id}"
  name    = "6na6lcj7onl5bco4ytfj4ud7p6t7kvtp._domainkey.dmarc.${aws_route53_zone.cyber_dhs_gov_zone.name}"
  type    = "CNAME"
  ttl     = 1800
...
resource "aws_route53_record" "dkim2_dmarc_CNAME" {
  zone_id = "${aws_route53_zone.cyber_dhs_gov_zone.zone_id}"
  name    = "nsbndtrubsyckjqnb4wkv6xdkrqe3dk5._domainkey.dmarc.${aws_route53_zone.cyber_dhs_gov_zone.name}"
  type    = "CNAME"
  ttl     = 1800
...
resource "aws_route53_record" "dkim3_dmarc_CNAME" {
  zone_id = "${aws_route53_zone.cyber_dhs_gov_zone.zone_id}"
  name    = "yhfkaco3ukhtbowt2bdvfz5czwuofitm._domainkey.dmarc.${aws_route53_zone.cyber_dhs_gov_zone.name}"
  type    = "CNAME"
  ttl     = 1800
...
resource "aws_route53_record" "drop_ncats_A" {
  zone_id = "${aws_route53_zone.cyber_dhs_gov_zone.zone_id}"
  name    = "drop.ncats.${aws_route53_zone.cyber_dhs_gov_zone.name}"
  type    = "A"
  ttl     = 60
  records = [ "64.69.57.40" ]
}
...
resource "aws_route53_record" "fw02_ncats_A" {
  zone_id = "${aws_route53_zone.cyber_dhs_gov_zone.zone_id}"
  name    = "fw02.ncats.${aws_route53_zone.cyber_dhs_gov_zone.name}"
  type    = "A"
  ttl     = 300
  records = [ "64.69.57.4" ]
}
...
resource "aws_route53_record" "rules_ncats_CNAME" {
  zone_id = "${aws_route53_zone.cyber_dhs_gov_zone.zone_id}"
  name    = "rules.ncats.${aws_route53_zone.cyber_dhs_gov_zone.name}"
  type    = "CNAME"
  ttl     = 300
...
resource "aws_route53_record" "vpn_ncats_CNAME" {
  zone_id = "${aws_route53_zone.cyber_dhs_gov_zone.zone_id}"
  name    = "vpn.ncats.${aws_route53_zone.cyber_dhs_gov_zone.name}"
  type    = "CNAME"
  ttl     = 300
...
resource "aws_route53_record" "rr_CNAME" {
  zone_id = "${aws_route53_zone.cyber_dhs_gov_zone.zone_id}"
  name    = "rr.${aws_route53_zone.cyber_dhs_gov_zone.name}"
  type    = "CNAME"
  ttl     = 60
